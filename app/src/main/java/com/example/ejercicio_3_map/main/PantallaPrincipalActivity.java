...
import com.example.ejercicio_3_map.main.ui.activity.LoginActivity;
import com.example.ejercicio_3_map.main.ui.activity.MapaFarmaciasActivity;
        ...
        firebaseHandler.obtenerUsuario(userId, task -> {
            if (task.isSuccessful() && task.getResult().exists()) {
                ...
                navigationView.findViewById(R.id.nav_map).setOnClickListener(v -> {
                    startActivity(new Intent(this, MapaFarmaciasActivity.class));
